...
You can think of this as the `{DrWatson.jl}` package being treated as a submodule of `Main` (see [the module section](./misc.qmd#modules) for more information about submodules).
